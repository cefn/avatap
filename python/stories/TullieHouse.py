...
with story:
    ...
    ThroughSequence(
		...
		sequence = [
            ...
            """ Your quest is to show
				...
				and sword skills in front
				of the assmebled crowd
				at the Hippika Gymnasia 
				game season at Uxelodunum 
				fort.""",
			""" Go over to the fort 
    ...
    NodeFork(
        uid =   "maskFork1",
        choices = {
			"trojan1":    	""" Collect the Trojan
								mask from the fort. """,
            "amazon1":   	""" Collect the Amazon
